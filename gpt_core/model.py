...
class Transformer(nn.Module):
    ...
    def generate(self, tokens, max_new_tokens, temperature=1.0, top_k=None, eos=None):
        ...
        This version is adapted to return a generator object for streaming inference.
        """
...
def print_model_parameters(model):
    ...
    print(f"Training model total of parameters: {param_sum/1e6:.2f}M")
...
if __name__ == "__main__":
    ...
    x = torch.tensor(
        [[8100, 1820, 4320, 311, 279, 7139, 3488, 315, 2324, 11, 279, 5861, 11, 323, 4395, 374, 220]]).to(device)
    print(x.shape)
    logits = model(x)
    print(logits.size())
